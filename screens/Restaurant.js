...
const requestgpsPermission = async () => {
    ...
    const granted = await PermissionsAndroid.request(
        ...
        {
          title: "Aplikacja Wacdonald potrzebuje dostępu do GPS",
          message:
            ...
            >
                {
                    restaurant?.menu.map((item, index) => (
                        ...
                        >
                            ...
                            >
                                <Text style={{ marginVertical: 10, marginTop: SIZES.padding *5, textAlign: 'center', ...FONTS.h2 }}>{item.name} - {item.price.toFixed(2)}</Text>
                            ...
                            >
                                ...
                                }}>{item.calories.toFixed(2)} kcal</Text>
                            </View>
                        </View>
                    ))
                }
        ...
        return (
            <View>
                ...
                >
                    ...
                    >
                        <Text style={{ ...FONTS.h3 }}>{getBasketItemCount()} w koszyku</Text>
                    ...
                    >
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            />
                            <Text style={{ marginLeft: SIZES.padding, ...FONTS.h4 }}>Lokalizacja</Text>
                        </View>
